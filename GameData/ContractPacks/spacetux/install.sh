...
OBJECTS=CHANGELOG-UnmannedContracts License-UnmannedContracts.txt UnmannedContracts.version coherentcontractsmod.cfg UnmannedContracts.dll group.cfg  UnmannedContracts.cfg
